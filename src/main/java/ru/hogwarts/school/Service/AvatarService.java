...
public class AvatarService {
    ...
    private AvatarRepositories avatarRepositories;

    public AvatarService(StudentService studentService, AvatarRepositories avatarRepositories) {
    ...
    public void uploadImage(Long studentId, MultipartFile avatarFile) throws IOException {
        ...
        Path filePath = Path.of(imagesDir, student + "." + getExtensions(avatarFile.getOriginalFilename()));
    ...
    public Avatar findAvatar(Long studentId) {
        return avatarRepositories.findByStudent(studentId).orElse(new Avatar());
    }
    ...
    public ResponseEntity<Collection<Avatar>> getAll(Integer pageNumber, Integer pageSize) {
        ...
        Collection<Avatar> avatarCollection = avatarRepositories.findAll(pageRequest).getContent();
